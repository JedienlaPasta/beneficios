...
import ChangeNameButton from "./ChangeNameBtn";
import ChangeNameModal from "./ChangeNameModal";
import { Modal } from "../Modal";
import ModalSkeleton from "../../modal-skeleton";
import { Suspense } from "react";
import ChangeTramoButton from "./ChangeTramoBtn";
import ChangeTramoModal from "./ChangeTramoModal";
import EditCitizenContactInfoModal from "./EditCitizenModal";
import EditButton from "../EditBtn";
import EditCitizenBirthdateModal from "./[id]/edit-modals/EditBirthdateModal";
import DetailCard from "../campañas/[id]/DetailCard";
            ...
            <div className="rounded-xl border border-slate-200 bg-gray-100">
              ...
              <div className="rounded-xl bg-white px-5 py-1 lg:px-8 lg:py-2">
                ...
                <DetailCard
                  ...
                  border={true}
                />
                <DetailCard name="Edad" value={age} />
              </div>
            </div>
            {/* 2nd segment */}
            <div className="rounded-xl border border-slate-200 bg-gray-100">
              ...
              <div className="rounded-xl bg-white px-5 py-1 lg:px-8 lg:py-2">
                ...
                <DetailCard
                  ...
                  border={true}
                />
                <DetailCard name="Correo" value={correo || "No registrado"} />
              </div>
            </div>
            {/* 3rd segment */}
