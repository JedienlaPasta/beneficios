...
export default function Sidenav() {
  return (
    <div className="fixed flex h-dvh w-60 shrink-0 flex-col border-r border-gray-900/10 bg-slate-100 text-slate-900">
      ...
      <section className="mx-4 my-4 flex flex-grow flex-col">
        <p className="mx-1 text-[10px] font-bold text-slate-900/50">
          MENÚ PRINCIPAL
        </p>
        <NavLinks />
      </section>
