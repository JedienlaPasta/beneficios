...
export default function ImportXLSXModal({ name }: { name: string }) {
  ...
  return (
    <div className="flex w-full max-w-full flex-1 shrink-0 flex-col gap-2 overflow-hidden bg-white p-4 shadow-xl ring-1 ring-slate-200/70 transition-all duration-500 scrollbar-hide sm:w-[28rem] sm:rounded-3xl sm:p-8">
      <div>
      ...
      <form onSubmit={formAction} className="flex flex-col gap-2">
        <div
          className="flex h-40 grow flex-col items-center justify-center gap-1.5 rounded-lg border border-dashed border-slate-400/60"
